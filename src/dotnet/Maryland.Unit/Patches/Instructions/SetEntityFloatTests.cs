...
{
    [TestClass]
    public sealed class SetEntityFloatTests
    {
        [TestMethod]
        public void ExposesGivenData()
        {
            ...
            var setEntityFloat = new SetEntityFloat(entity, attribute, value);

            Assert.AreEqual(entity, setEntityFloat.Entity);
            Assert.AreEqual(attribute, setEntityFloat.Attribute);
            Assert.AreEqual(value, setEntityFloat.Value);
        }
        ...
        public void AppliesToDatabases()
        {
            ...
            database.Verify(d => d.SetEntityFloat(entity, attribute, value), Times.Once);
        ...
        public void Serializes()
        {
            ...
            var bytes = setEntityFloat.Serialized;
