...
{
    [TestClass]
    public sealed class SetEntityFlagTests
    {
        [TestMethod]
        public void ExposesGivenData()
        {
            ...
            var setEntityFlag = new SetEntityFlag(entity, attribute);

            Assert.AreEqual(entity, setEntityFlag.Entity);
            Assert.AreEqual(attribute, setEntityFlag.Attribute);
        }
        ...
        public void AppliesToDatabases()
        {
            ...
            setEntityFlag.ApplyTo(database.Object);

            database.Verify(d => d.SetEntityFlag(entity, attribute), Times.Once);
        ...
        public void Serializes()
        {
            ...
            var bytes = setEntityFlag.Serialized;
